  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'aboutBadges',     label: 'Closing — reassurance badges', type: 'textarea',
        default: '⊛ Data Secure\nॐ Vedic Authentic\n◆ AI Enhanced\n◈ Instant Results',
        help: 'One per line, symbol first then the words.' },
    ],
  },
  {
    key: 'onboarding',
...
const LISTS = {
  ...
  nav_items: {
    ...
    seed: [
      ...
      { group: 'Panchang',  icon: 'ॐ', label: "Today's Panchang",       to: '/panchang' },
      ...
      { group: 'Tools',     icon: '◆', label: 'Festival Calendar',  to: '/festivals' },
      { group: 'Tools',     icon: '✦', label: 'Crystal & Gem Guide', to: '/crystals' },

      { group: 'Shop',      icon: '◆', label: 'Astro Mall',   to: '/mall' },
  ...
  pages: {
    ...
    fields: [
      ...
      { key: 'icon',  label: 'Symbol', type: 'text', default: '◆' },
  ...
  onboarding_criteria: {
    ...
    seed: [
      ...
      { emoji: '◈', title: 'Fluent in Hindi or English',
      ...
      { emoji: '✦', title: 'No fear-based predictions',
  ...
  onboarding_kit: {
    ...
    seed: [
      ...
      { emoji: '◈', tone: 'violet', title: 'The Pandit Portal',
