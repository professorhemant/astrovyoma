// The 17 stones behind /crystals — the nine Navagraha gemstones and eight
// healing crystals.
//
// Moved out of the controller so it can be two things at once: the seed for the
// editable "Crystals" list (config/contentSchema.js), and the fallback the
// controller falls back to if that list is ever emptied. Same arrangement as
// blogArticles.js and mallProducts.js.
//
// Nothing here is the live copy any more. Once the site has booted, what
// visitors see is whatever is in the database, which the admin can edit.
