...
const AiChatMessage = require('./AiChatMessage')(sequelize);
...
module.exports = { sequelize, User, Astrologer, Kundali, Consultation, Message, AiChatMessage, OtpCode, Transaction, Review, Subscription, Appointment, UserReport, AstrologerApplication, SiteSetting, ContentItem };
