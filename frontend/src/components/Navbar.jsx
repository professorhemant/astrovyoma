...
const FREE_TOOLS_ITEMS = [
  ...
  { to:'/domain-report', icon:'🔭', label:'Life Domain Report', dividerAfter: true },
  { to:'/kp-astrology',         icon:'🔯', label:'KP Astrology' },
  { to:'/dream-interpretation', icon:'🌙', label:'Dream Interpretation' },
