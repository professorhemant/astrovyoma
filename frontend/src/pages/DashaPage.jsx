...
const DASHA_INFO = {
  Sun:     { years: 6,  color: '#FF9F43', icon: '☉', keywords: 'Authority, Father, Career, Health, Government', meaning: 'A period of self-realization, leadership, and connection to authority figures. Your soul seeks recognition and purpose. Health, career advancement, and relationship with father figures are highlighted.' },
  ...
  Ketu:    { years: 7,  color: '#FD79A8', icon: '☋', keywords: 'Spirituality, Liberation, Past Life, Detachment, Healing', meaning: 'A period of deep spiritual seeking and detachment from material things. Past life karma surfaces for resolution. Unexpected events lead to inner liberation. Healing gifts, psychic sensitivity, and moksha-seeking are heightened.' },
