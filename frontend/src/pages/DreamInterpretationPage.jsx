...
const T = {
  en: {
    ...
    lockedTitle: 'The reading itself is part of a plan',
    lockedBodyAuth: 'The watch of the night and the symbols above are yours for nothing. The full reading — woven together, and read against your own birth chart and running dasha — comes with a subscription.',
    lockedBodyPlan: 'Your plan does not cover this yet. The full reading is read against your own birth chart and your running dasha, which is something no other dream tool can do.',
    signIn: 'Sign in',
    seePlans: 'See plans',
    switchTo: 'हिंदी',
    langName: 'English',
  ...
  hi: {
    ...
    lockedTitle: 'पूरी व्याख्या सदस्यता में मिलती है',
    lockedBodyAuth: 'ऊपर का पहर और प्रतीक आपके लिए नि:शुल्क हैं। पूरी व्याख्या — सब जोड़कर, और आपकी अपनी जन्मकुंडली तथा चल रही दशा के साथ पढ़ी हुई — सदस्यता के साथ मिलती है।',
    lockedBodyPlan: 'आपकी वर्तमान योजना में यह शामिल नहीं है। पूरी व्याख्या आपकी जन्मकुंडली और चल रही दशा के साथ पढ़ी जाती है — जो और कोई स्वप्न-सुविधा नहीं कर सकती।',
    signIn: 'साइन इन करें',
