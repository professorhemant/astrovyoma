...
const heroBannerStyle = { height: 'clamp(300px, 55vh, 640px)', objectFit: 'cover', objectPosition: 'center' };
  ...
  return (
    <>
      ...
      <div className="relative min-h-screen overflow-x-hidden" style={{ zIndex: 3 }}>
        ...
        {/* ── CTA Buttons — Row 2 ── */}
        <div className="relative z-10 flex flex-col sm:flex-row gap-2 justify-center items-center pb-4 px-4">
          <Link to="/vastu"
            className="flex items-center justify-center gap-2 px-6 py-2 text-xs font-semibold rounded-full transition-all hover:scale-105"
