...
const CARDS = [
  ...
  { icon:'♥', title:'Match Horoscope',                 desc:'Guna milan compatibility with your partner',           link:'/matching',        bg:'from-rose-500 to-pink-600' },
  ...
  { icon:'↑', title:'Ascendant',                      desc:'Know your rising sign and its influence',             link:'/kundali',         bg:'from-emerald-500 to-green-600' },
  ...
  { icon:'☉', title:'My Day Today',                    desc:"Know today's predictions based on your chart",        link:'/panchang',        bg:'from-orange-400 to-yellow-500' },
  ...
  { icon:'♥', title:'Love',                            desc:'Know about your Love life and relationships',          link:'/purpose',         bg:'from-pink-500 to-rose-600' },
